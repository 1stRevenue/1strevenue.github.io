  ...
  function (e, t, o, n, r, i, s) {
    ...
    var l = [
          ...
          if (console.log(a, 'inviteExisting', 'mapValue=', t.mapValue, 'ivUser=', t), t.mapValue) {
            ...
            r.once('value', function (n) {
              ...
              console.log(a, 'inviteExisting', 'userRecordRef once value userRecord=', i), e(function () {
                t.record = i, t.userRef = r, u.userId = n.name(), o.resolve(t);
              });
            }, function (e) {
        ...
        inviteModels: function () {
          console.log(a, 'inviteModels userId=', u.fbUser.userId);
          ...
          return _.each(e, function (e) {
            ...
            t.push(r.promise), console.log(a, 'inviteModels setting userId=', u.fbUser.userId), o.child('users').child(u.fbUser.userId).set(!0, function (t) {
