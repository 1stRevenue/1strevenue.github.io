...
FirstRevenueApp.controller('AdminController', [
  ...
  function (e, t, o, n, i) {
    ...
    angular.extend(e, {
      ...
      showBusinessCard: function (t, o) {
        console.log(r, 'showBusinessCard type=', t, 'user=', o);
        var n = o.image;
  ...
  '$timeout',
  function (e, t, o) {
    var n = 'GPlus', i = 'https://api.singly.com/profiles/gplus?auth=true&access_token=:token', r = 'https://api.singly.com/proxy/google/plus/v1/people/me', s = 'https://api.singly.com/proxy/google/plus/v1/people/me/people/visible', a = {
        me: null,
        account: null,
        total: 0,
        people: null,
